...
class helpfun(commands.Cog):
	...
	async def help(self, ctx, command = None):
		if command is None:
			embed = discord.Embed(title = "Lista de comandos, clique aqui para saber mais", url = "https://www.youtube.com/watch?v=dQw4w9WgXcQ", description = "Tens o que é necessário para esmagares meu comando? Para saber sobre comandos específicos use $help nomedocomando", color = 0x054f77)
			...
			embed.add_field(name = "Comandos musicais", value = "play(p), next(n), prev, remove, repeat, clear, jump, shuffle, q, pause, resume, stop.", inline = False)
			...
			await ctx.send("Comando específico, meia noite eu boto")
